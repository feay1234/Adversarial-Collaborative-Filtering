...
class DRCF(BPR):
    ...
    def __init__(self, num_users, num_items, dim, maxVenue =5, opt=Adam()):
        ...
        # Dot-product of user and item embeddings
        self.mlp_dot_vector = Dot()([Add()([self.mlp_dot_dynamic_user_latent, self.mlp_dot_user_latent]), self.mlp_dot_item_latent])
        self.mlp_dot_neg_vector = Dot()([Add()([self.mlp_dot_dynamic_user_latent, self.mlp_dot_user_latent]), self.mlp_dot_item_neg_latent])
